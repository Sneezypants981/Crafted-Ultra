...
public class CyanowoodButtonBlock extends CraftedUltraModElements.ModElement {
	@ObjectHolder("crafted_ultra:cyanowood_button")
	public static final Block block = null;
	public CyanowoodButtonBlock(CraftedUltraModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("cyanowood_button");
		}
