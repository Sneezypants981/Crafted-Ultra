...
public class CyanowoodLogBlock extends CraftedUltraModElements.ModElement {
	@ObjectHolder("crafted_ultra:cyanowood_log")
	public static final Block block = null;
	public CyanowoodLogBlock(CraftedUltraModElements instance) {
		super(instance, 3);
	}
