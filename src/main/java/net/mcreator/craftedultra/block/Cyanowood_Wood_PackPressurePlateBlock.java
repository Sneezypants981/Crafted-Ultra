...
public class Cyanowood_Wood_PackPressurePlateBlock extends CraftedUltraModElements.ModElement {
	@ObjectHolder("crafted_ultra:cyanowood_wood_pack_pressure_plate")
	public static final Block block = null;
	public Cyanowood_Wood_PackPressurePlateBlock(CraftedUltraModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("cyanowood_wood_pack_pressure_plate");
		}
